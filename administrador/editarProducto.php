    ...
    <div class="formulario">
        ...
        <form action="actualizarProducto.php?idProducto=<?php echo $idProducto;?>&idUsuario=<?php echo $idUsuario;?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="stockMin"  name="stockMin" value="<?php echo $row['stockMin'];?>">
            </div>
            <div class="mb-3">
                <label for="stockMax" class="form-label">Punto Máximo</label>
                <input type="number" class="form-control" id="stockMax"  name="stockMax" value="<?php echo $row['stockMax'];?>">
            </div>
            <div class="mb-3">
