<?php
    ...
    $sql4 = "SELECT * FROM proveedor $where";
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active">
                    <div class='row busqueda'>
                        ...
                        <div class="col">
                        <a href="nuevoProveedor.php?idUsuario=<?php echo $idUsuario;?>" type="button" class="btn btn-primary">Crear nuevo proveedor</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-warning table-striped table-bordered table-sm align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-warning"><?php echo $row4['celularProveedor'];?></td>
                                        <td class="table-warning"><?php echo $row4['correoProveedor'];?></td>
                                        <td class="table-warning">
                                            <a href="editarProveedor.php?idProveedor=<?php echo $row4['idProveedor'];?>&idUsuario=<?php echo $row['idUsuario'];?>" type="button" class="btn btn-secondary">Editar</a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
