...
$sql1 = "SELECT idProducto,parteNumero,nombre,stock,stockMin,stockMax,producto.idProveedor,
ubicacion,estado,proveedor.nombreProveedor FROM producto INNER JOIN proveedor 
ON producto.idProveedor= proveedor.idProveedor where estado = 1 $where ORDER BY producto.idProducto";
    ...
    <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" background="yellow">
                    <div class='row busqueda'>
                        ...
                        <!-- <div class="col">
                            <a href="nuevoProducto.php?idUsuario=<?php echo $idUsuario;?>" type="button" class="btn btn-primary crear">Crear nuevo producto</a>
                        </div> -->
                    </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="table-warning">
                                        <a href="solicitarProducto.php?idProducto=<?php echo $row1['idProducto']; ?>&idUsuario=<?php echo $row['idUsuario']; ?>" type="button" class="btn btn-secondary">Solicitar</a>
                                    </td>
                                </tr>
                            <?php
                            }
